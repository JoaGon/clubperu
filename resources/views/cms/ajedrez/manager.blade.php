             ...
             <div class="row col-lg-12" style="margin: 15px">
                <div class="box box-info"  style="margin-top: 5%;">
                   <div class="box-header with-border ">
                        <h3 class="box-title">Managers Ajedrez</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div style="padding-bottom: 20px;color: white;padding-top: 10px; font-size: 20px;font-weight: bold;text-align: center;">
                                                <a class="col-xs-12 col-sm-3 col-md-3" ng-click="edit({{$sport->id_sport_manager}})"> 
                                        ...
                                        <td class="childTd" style="width: 15%;">
                                            <div style="padding-bottom: 20px;color: white;padding-top: 10px; font-size: 20px;font-weight: bold;text-align: center;">
                                                <a class="col-xs-12 col-sm-3 col-md-3" id="try" data-link="{{ url('/edit_slide') }}" onclick="edit({{$sport->id_sport_manager}})"> 
                                                    <i class="fa fa-edit pull-right delete" style="font-family: FontAwesome !important;width: 20%;">
                                                    </i>
                                                </a>
                                                <a class="col-xs-12 col-sm-3 col-md-3" onclick="remove({{$sport->id_sport_manager}})"> 
            ...
            <div class="modal fade bs-modal" id="modal_beneficio" tabindex="-1" role="dialog">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <form id="form_create" action="manager_create_ajedrez" enctype="multipart/form-data" method="POST" >
