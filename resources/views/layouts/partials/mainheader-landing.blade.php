            ...
            <div style="height: 70px;" class="uk-sticky-placeholder">
                ...
                <nav style="position: fixed; top: 0px; width: 100%;" class="tm-navbar uk-navbar uk-active" data-uk-sticky="">
                    <div class="uk-container uk-container-center">
                        <a class="tm-logo uk-float-left otro-logo" href="{{url('/')}}">
                            <img src="img/landing/logo.jpg" alt="logo" title="logo">
                        </a>

                        <ul class="uk-navbar-nav uk-hidden-small">
                            <li class="uk-parent uk-active" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="{{url('/')}}">Inicio</a>
                            ...
                            <li class="uk-parent" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a  href="{{url('/')}}">Eventos</a>
                                <div class="uk-dropdown uk-dropdown-navbar uk-dropdown-width-1">
                                    <div class="uk-grid uk-dropdown-grid">
                                        <div class="uk-width-1-1">
                                            <ul class="uk-nav uk-nav-navbar">
